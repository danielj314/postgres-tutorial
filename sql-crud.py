...
# solution to challenge, create one more record
# on ths Programmer table
daniel_jones = Programmer(
    first_name="Daniel",
    last_name="Jones",
    gender="F",
    nationality="British",
    famous_for="passing PP1 and PP2"
)
...
# session.add(daniel_jones)


# updating a single record
# programmer = session.query(Programmer).filter_by(id=7).first()
# programmer.famous_for = "World Leader"
